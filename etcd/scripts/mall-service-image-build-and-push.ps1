...
$imageName = "registry.cn-hangzhou.aliyuncs.com/jianxin-zx/mall-service"
$imageTag = "latest"

$dockerfilePath = "../../mall.server/src/Wallee.Mall.HttpApi.Host/Dockerfile"
$contextPath = "../../mall.server"
