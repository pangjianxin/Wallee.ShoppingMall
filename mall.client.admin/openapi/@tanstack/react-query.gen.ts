...
export const productDeleteSkuMutation = (options?: Partial<Options<ProductDeleteSkuData>>): UseMutationOptions<unknown, ProductDeleteSkuError, Options<ProductDeleteSkuData>> => {
    const mutationOptions: UseMutationOptions<unknown, ProductDeleteSkuError, Options<ProductDeleteSkuData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await productDeleteSku({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
