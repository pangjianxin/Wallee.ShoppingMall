...
export const productCreateByJdSkuMutation = (options?: Partial<Options<ProductCreateByJdSkuData>>): UseMutationOptions<unknown, ProductCreateByJdSkuError, Options<ProductCreateByJdSkuData>> => {
    const mutationOptions: UseMutationOptions<unknown, ProductCreateByJdSkuError, Options<ProductCreateByJdSkuData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await productCreateByJdSku({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const productUpdateCoversMutation = (options?: Partial<Options<ProductUpdateCoversData>>): UseMutationOptions<ProductUpdateCoversResponse, ProductUpdateCoversError, Options<ProductUpdateCoversData>> => {
    const mutationOptions: UseMutationOptions<ProductUpdateCoversResponse, ProductUpdateCoversError, Options<ProductUpdateCoversData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await productUpdateCovers({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
