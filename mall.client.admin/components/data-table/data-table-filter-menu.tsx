        ...
        <CommandGroup>
          ...
          >
            {isEmpty ? (
              ...
              <>
                <BadgeCheck />
                <span className="truncate">按 &quot;{value}&quot; 过滤</span>
              </>
            )}
          </CommandItem>
        </CommandGroup>
        ...
        <Popover open={showValueSelector} onOpenChange={setShowValueSelector}>
          <PopoverTrigger asChild>
            <Button
              ...
              variant="ghost"
              size="sm"
              className="h-full min-w-32 rounded-none border px-1.5 font-normal dark:bg-input/30"
            >
