    ...
    <SortableItem value={filter.filterId} asChild>
      ...
      >
        <div className="min-w-[72px] text-center">
          {index === 0 ? (
            <span className="text-muted-foreground text-sm">其中</span>
          ) : index === 1 ? (
            <Select
              value={joinOperator}
    ...
    case "range": {
      ...
      return (
        <Input
          ...
          placeholder={columnMeta?.placeholder ?? "输入一个值..."}
        ...
        >
          ...
          <FacetedContent id={inputListboxId} className="w-[200px]">
            <FacetedInput
              ...
              placeholder={columnMeta?.placeholder ?? "搜索选项..."}
            />
            <FacetedList>
              <FacetedEmpty>未找到选项。</FacetedEmpty>
              <FacetedGroup>
