...
namespace Wallee.Mall.Migrations
{
    ...
    [Migration("20260129091819_ModProduct1")]
    partial class ModProduct1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wallee.Mall.Carousels.Carousel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppCarousels", (string)null);
                });

            modelBuilder.Entity("Wallee.Mall.Carts.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Wallee.Mall.Carts.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Wallee.Mall.Medias.MallMedia", b =>
                {
                    ...
                    b.ToTable("AppMallMedias", (string)null);
                });
            ...
            modelBuilder.Entity("Wallee.Mall.Products.Product", b =>
                {
                    ...
                    b.HasIndex("IsActive", "SortOrder", "SalesCount");

                    b.ToTable("AppProducts", (string)null);
                });

            modelBuilder.Entity("Wallee.Mall.Products.ProductSku", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("AttributesSignature")
                        .IsRequired()
                        .HasMaxLength(2048)
                        .HasColumnType("character varying(2048)");
                    ...
                    b.Property<decimal?>("JdPrice")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("JdSkuId")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("ProductId", "AttributesSignature")
                        .IsUnique();

                    b.HasIndex("ProductId", "JdSkuId")
                        .IsUnique();

                    b.ToTable("AppProductSkus", (string)null);
                });
            ...
            modelBuilder.Entity("Wallee.Mall.Tags.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Wallee.Mall.Carts.CartItem", b =>
                {
                    b.HasOne("Wallee.Mall.Carts.Cart", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Wallee.Mall.Products.Product", b =>
                {
                    b.OwnsMany("Wallee.Mall.Products.ProductCover", "ProductCovers", b1 =>
                        {
                            b1.Property<Guid>("ProductId");
                            ...
                            b1.Property<Guid>("MallMediaId");

                            b1.HasKey("ProductId", "__synthesizedOrdinal");

                            b1.ToTable("AppProducts");

                            b1.ToJson("ProductCovers");

                            b1.WithOwner()
                                .HasForeignKey("ProductId");
                        });

                    b.OwnsOne("Wallee.Mall.Products.Strategy.ProductSkuSnapshot", "SkuSnapshot", b1 =>
                        {
                            b1.Property<Guid>("ProductId");

                            b1.Property<decimal?>("JdPrice")
                                .HasColumnType("decimal(18,2)");

                            b1.Property<string>("JdSkuId")
                                .IsRequired();
                            ...
                            b1.ToJson("SkuSnapshot");

                            b1.WithOwner()
                                .HasForeignKey("ProductId");
                        });

                    b.Navigation("ProductCovers");
            ...
            modelBuilder.Entity("Wallee.Mall.Products.ProductSku", b =>
                {
                    ...
                    b.OwnsMany("Wallee.Mall.Products.ProductSkuAttribute", "Attributes", b1 =>
                        {
